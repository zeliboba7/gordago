...
namespace Gordago.StockOptimizer2.Toolbox {
  ...
  [Function("FATL")]
	public class FATL: Function {
      ...
      RegParameter(new ParameterColor("ColorFATL", new string[] { "Color", "Цвет" }, Color.BlueViolet));
		}
  ...
  [Function("RFTL")]
	public class RFTL: Function {
		...
		protected override void Initialize() {
			RegParameter(Function.CreateDefParam_ApplyTo("Close"));
      RegParameter(new ParameterColor("ColorRFTL", new string[] { "Color", "Цвет" }, Color.GreenYellow));
		}
  ...
  [Function("SATL")]
	public class SATL: Function {
		...
		protected override void Initialize() {
			RegParameter(Function.CreateDefParam_ApplyTo("Close"));
      RegParameter(new ParameterColor("ColorSATL", new string[] { "Color", "Цвет" }, Color.DeepSkyBlue));
		}
  ...
  [Function("RSTL")]
    ...
    protected override void Initialize() {
      RegParameter(Function.CreateDefParam_ApplyTo("Close"));
      RegParameter(new ParameterColor("ColorRSTL", new string[] { "Color", "Цвет" }, Color.Gold));
    }
